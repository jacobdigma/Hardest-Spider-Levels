...
export default {
    ...
    data() {
        return {
            ...
            list: [
                // --- MAIN LIST ---
                { name: "level1", author: "sigmaauthor", verifier: "y", points: 200, type: "main", minimum: 73, verification: "#", records: [{ user: "victor", percent: 100, link: "#" }] },
                // --- EXTENDED LIST ---
                { name: "level2", author: "sigmaauthor", verifier: "o", points: 155, type: "extended", minimum: 78, verification: "#", records: [] },

                // --- LEGACY LIST ---
                { name: "legacy", author: "ligmaauthor", verifier: "y", points: 0, type: "legacy", verification: "#", records: [{ user: "close", percent: 54, link: "#" }] }
                       ]
        };
    },
       mounted() {
